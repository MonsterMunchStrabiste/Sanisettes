...
public class RVFragment extends Fragment {
    ...
    /**
     * @return a new instance of {@link RVFragment}, adding the parameters into a bundle and
     * setting them as arguments.
     */
    public static RVFragment newInstance(CharSequence title, int indicatorColor,
            int dividerColor) {
